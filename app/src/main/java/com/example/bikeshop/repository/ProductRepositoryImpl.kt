...
class ProductRepositoryImpl (val database: FirebaseDatabase): ProductRepository {

    val ref = database.reference.child("products")

    private val cloudinary = Cloudinary(
        mapOf(
            "cloud_name" to "dp4jg3dx9",
            "api_key" to "793895163236148",
            "api_secret" to "MvTPP9FXiR_hqsYQehfsFkPNcyE"
        )
    )
